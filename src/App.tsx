...
import { Mail, Phone, MapPin, Github, Linkedin, ChevronDown, GraduationCap, Briefcase, Award } from 'lucide-react';
    ...
    >
      <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex gap-6 text-gray-300">
          {['关于我', '经历', '技能', '联系'].map((item, i) => (
            <motion.a
              key={item}
              href={`#${['about', 'experience', 'skills', 'contact'][i]}`}
              whileHover={{ y: -2 }}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed">
              {resumeData.bio} 对新技术充满热情，乐于探索创新解决方案。
            </p>
          </motion.div>
  ...
  return (
    <section id="experience" className="py-20 bg-black">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          <h2 className="text-3xl font-bold mb-4">
            <span className="bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">工作经历</span>
          </h2>
